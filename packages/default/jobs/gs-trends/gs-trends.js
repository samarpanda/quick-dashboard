...
module.exports = function(config, dependencies, job_callback) {
    ...
    // You can add unit tests to ensure this (see test/gs-trends file)
    // Your config check may look something like this:
    // if (!config.globalAuth || !config.globalAuth[authName] ||
    //   !config.globalAuth[authName].username || !config.globalAuth[authName].password) {
    //   return job_callback('no credentials found in the gs-trends job. Please check the global authentication file!');
    // }
